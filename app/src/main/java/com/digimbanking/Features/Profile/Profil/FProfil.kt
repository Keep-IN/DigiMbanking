 ...
 * Use the [FProfil.newInstance] factory method to
...
class FProfil : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = FragmentFProfilBinding.inflate(layoutInflater)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_f_profil, container, false)
    }
